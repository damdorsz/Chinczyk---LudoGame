...
Board::Board(unsigned int players,QVector<PlayerColor> tablicaGraczyKolor) :
    ...
    mTablicaGraczyKolor = tablicaGraczyKolor;
    /* Initialize the player vector */
    #pragma GCC diagnostic ignored "-Wimplicit-fallthrough"
    switch(players) {
        case 4:
            mTablicaGraczyKolor[3]= tablicaGraczyKolor[3];
            mPawns.append(new Pawn(tablicaGraczyKolor[3], 0 ,4));
            mPawns.append(new Pawn(tablicaGraczyKolor[3], 1 ,4));
            mPawns.append(new Pawn(tablicaGraczyKolor[3], 2 ,4));
            mPawns.append(new Pawn(tablicaGraczyKolor[3], 3 ,4));
        case 3:
            mTablicaGraczyKolor[2]= tablicaGraczyKolor[2];
            mPawns.append(new Pawn(tablicaGraczyKolor[2], 4 ,3));
            mPawns.append(new Pawn(tablicaGraczyKolor[2], 5 ,3));
            mPawns.append(new Pawn(tablicaGraczyKolor[2], 6 ,3));
            mPawns.append(new Pawn(tablicaGraczyKolor[2], 7 ,3));
        case 2:
            mTablicaGraczyKolor[1]= tablicaGraczyKolor[1];
            mPawns.append(new Pawn(tablicaGraczyKolor[1], 8 ,2));
            mPawns.append(new Pawn(tablicaGraczyKolor[1], 9 ,2));
            mPawns.append(new Pawn(tablicaGraczyKolor[1], 10 ,2));
            mPawns.append(new Pawn(tablicaGraczyKolor[1], 11 ,2));

            mTablicaGraczyKolor[0]= tablicaGraczyKolor[0];
            mPawns.append(new Pawn(tablicaGraczyKolor[0], 12 ,1));
            mPawns.append(new Pawn(tablicaGraczyKolor[0], 13 ,1));
            mPawns.append(new Pawn(tablicaGraczyKolor[0], 14 ,1));
            mPawns.append(new Pawn(tablicaGraczyKolor[0], 15 ,1));
            break;
